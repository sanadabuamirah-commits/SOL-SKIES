...
var ICONS = {
  add: async () => (await import("./add-6TRASPJW.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-CA62FSUU.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-XRACPDGQ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-SMK2R3UQ.js")).appStoreSvg,
  apple: async () => (await import("./apple-HUXRITRD.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-JNKSNA5I.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-UTO72KET.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-X3O3CBKK.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-7JO46AB2.js")).arrowTopSvg,
  bank: async () => (await import("./bank-PVEHDBQB.js")).bankSvg,
  browser: async () => (await import("./browser-F4TLBBIB.js")).browserSvg,
  card: async () => (await import("./card-RXTGCIPG.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-TWKCPQEP.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-446LCA4X.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-YRWCCY4P.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-E2QRPZDZ.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-DJOYZ4EX.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-SGAIIIUQ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-XEKNZWWC.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-D5P7NKVQ.js")).clockSvg,
  close: async () => (await import("./close-Z7DDGGO4.js")).closeSvg,
  compass: async () => (await import("./compass-EIVNP3ZG.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-HMU2YRU2.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-A7QLOARK.js")).copySvg,
  cursor: async () => (await import("./cursor-XAGJBRTZ.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-3UBN6XG5.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-2PJHUYFH.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-BKTMGXBT.js")).disconnectSvg,
  discord: async () => (await import("./discord-5X2KWG4T.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-YNYDNBII.js")).etherscanSvg,
  extension: async () => (await import("./extension-UGIBTGQJ.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CSNXK4WB.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-QGHEYW6K.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-4B3ONVZV.js")).farcasterSvg,
  filters: async () => (await import("./filters-MM42ZQRA.js")).filtersSvg,
  github: async () => (await import("./github-TCXBXVYE.js")).githubSvg,
  google: async () => (await import("./google-DM6F5QFO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-KCV2SL5Y.js")).helpCircleSvg,
  image: async () => (await import("./image-25YRMDVO.js")).imageSvg,
  id: async () => (await import("./id-R37LRH22.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-ZVVRB7U7.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-WQ5TYR3L.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LWGKSM75.js")).mailSvg,
  mobile: async () => (await import("./mobile-JV4THR75.js")).mobileSvg,
  more: async () => (await import("./more-ILG62UPF.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-TXIFXR3W.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ATT56NJD.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-OKQX7ZSZ.js")).offSvg,
  playStore: async () => (await import("./play-store-KL5V7W7W.js")).playStoreSvg,
  plus: async () => (await import("./plus-AYNNMT4R.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-FODNSFGF.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-WLB2D6VJ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-OEBOEQVC.js")).refreshSvg,
  search: async () => (await import("./search-CU2Q3QFK.js")).searchSvg,
  send: async () => (await import("./send-QS6PZCCR.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-WEUNMND7.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-DLW42T3U.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-VQFVUNC6.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-YNCJ4RD6.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-64LGUUKE.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-ZKBA2RF5.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-JGRXOFXZ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-W3QBPAPA.js")).twitchSvg,
  twitter: async () => (await import("./x-7THAEUEQ.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-LKWR3XZE.js")).twitterIconSvg,
  verify: async () => (await import("./verify-BF2UCELW.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-ZCCDUKRU.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-WTEJL323.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ZPZ2LOPQ.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ZPZ2LOPQ.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ZPZ2LOPQ.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-OY6D3372.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CCCGSQXB.js")).warningCircleSvg,
  x: async () => (await import("./x-7THAEUEQ.js")).xSvg,
  info: async () => (await import("./info-EPW72NTT.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-BFKN2OAN.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-H5LVNVLA.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZL6YUE2A.js.map
